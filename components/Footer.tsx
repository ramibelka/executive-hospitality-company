...
const Footer = () => {
  return (
    <footer className="h-screen w-screen overflow-hidden bg-white px-20 pb-10 pt-20">
      <div className="flex h-full w-full flex-col items-center justify-around">
        ...
        <div className="flex w-full flex-col items-center gap-6">
          ...
          <div className="flex w-full items-center justify-between border-t-[1px] border-stone-300 text-sm">
